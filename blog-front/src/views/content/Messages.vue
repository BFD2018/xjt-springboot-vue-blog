      ...
      <div class="guest-input">
        <el-form :inline="true" :rules="rules" ref="guestLogin" :model="guestLoginForm" class="demo-form-inline">
          ...
          <el-form-item prop="password">
            <el-input v-model="guestLoginForm.password" type="password" placeholder="密码"></el-input>
          </el-form-item>
        </el-form>
      </div>
                ...
                <el-row :gutter="15" type="flex">
                  ...
                  <el-col :span="20" style="background-color: #eee;margin-left: 10px;padding: 5px;">
                    <div style=" width: 100%;">
                      ...
                      <span
                        style="font-size: 14px;line-height: 26px;font-weight: normal;color: #007eff;margin-left: 10px;">@{{item2.parent_message_nickname}}</span>
